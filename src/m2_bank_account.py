...
def run_test_init():
    ...
    # ---------------------------------------------------------------------
    b2= Bank('Brackin2', 10, 'A2')
    expected_name = 'Brackin2'
    expected_balance = 10
    ...
    if (expected_name == b2.name) and (expected_balance == b2.balance) and (expected_account_number == b2.account_number):
        ...
        print_failure_message()
    print()
    b3= Bank('Brackin3', 18900, 'A3')
    expected_name = 'Brackin3'
    expected_balance = 18900
...
# Implement at least two tests.  Use copy and paste to speed your coding.
    b2 = Bank('Gab', 20200, 'A1')
    print('Expected:', '200')
    print('Actual:  ', b2.withdraw(20000))
    if b2.withdraw(20000) is 200:
        print('Test passed SUCCESSFULLY!')
    else:
        print_failure_message()
    print()
    ...
    b3 = Bank('Meow', 10, 'A2')
    print('Expected:', 3)
    print('Actual:  ', b3.withdraw(7))
    if b3.withdraw(7) is 3:
        print('Test passed SUCCESSFULLY!')
    else:
        print_failure_message()
    print()
